...
def get_char_vocab_language(language):
  ...
  #get_char_vocab(["{}.{}.jsonlines".format(partition, language) for partition in ("train", "test")], "char_vocab.{}.txt".format(language))
  #get_char_vocab(["{}.{}.jsonlines".format("train", language)], "char_vocab.{}.txt".format(language))
